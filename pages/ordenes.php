        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#nuevo">Agregar Orden</button>
                    <button class="btn btn-warning" data-toggle="modal" data-target="#nuevo">Modificar Orden</button>
                    <button class="btn btn-danger" data-toggle="modal" data-target="#nuevo">Eliminar Orden</button>
                </div>
